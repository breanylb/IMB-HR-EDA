-- VIEWING THE FIRST 20 ROWS IN DATASET
SELECT
  *  
FROM 
...
--FINDING NUMBER OF EMPLOYEES GROUP BY BUSINESS TRAVEL, DEPARTMENT, EDUCATION FIELD, GENDER, JOBLEVEL, JOB ROLE, MARITAL STATUS
SELECT
...
--LOOKIING AY YEARS AT COMPANY, YEARS SINCE LAST PROMOTION, YEARS IN CURRENT ROLE
SELECT
